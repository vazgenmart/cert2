            ...
            <nav id="sidebar">
                <div id="main-menu">
                    <ul class="sidebar-nav">
                        ...
                        <?php endif; ?>
                        <?php if (Yii::$app->user->identity->can('Organizations', 'read')): ?>
                            <li class="<?php echo Yii::$app->controller->id == "organizations" ? "current" : ""; ?>">
                                <a href="<?php echo Url::to(['organizations/index']) ?>"><i class="fa fa-cog"></i>
                                    <span class="sidebar-text"> <?php echo Yii::t('app', 'Organizations') ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                    </ul>
